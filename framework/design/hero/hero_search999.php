...
add_filter( 'ppt_blocks_args',  array('block_hero_search999',  'data') );
add_action( 'hero_search999',  			array('block_hero_search999', 'output' ) );
add_action( 'hero_search999-css',  		array('block_hero_search999', 'css' ) );
add_action( 'hero_search999-js',  		array('block_hero_search999', 'js' ) );

class block_hero_search999 {
	...
	public static function data($a){ 
		...
		$a['hero_search999'] = array(
			"name" 	=> "Hero Search 999",
			"image"	=> "hero_search999.jpg",
			"cat"	=> "hero",
			"order" => 1,
			"desc" 	=> "", 
			"data" 	=> array( ),	
		...
		$settings = $CORE->LAYOUT("get_block_settings_defaults", array("hero_search999", "hero", $settings ) );
		...
		if($settings['hero_image'] == ""){
			...
			$default_data = $CORE->LAYOUT("get_block_defaults", "hero_search999");		 	 
...
<div class="container">
  <div class="col-md-6 col-lg-5 col-xl-4">
    <div class="bg-white text-dark shadow p-4" style="height:413px">
      <?php 
			    
			 // _ppt_template( 'framework/design/parts/title' ); ?>
      <?php 
      //_ppt_template( 'framework/design/parts/search-list999' );
      
       ?>
       
        
    	 <?php _ppt_template( 'framework/design/widgets/widget-menu999' );?>
