...
.pure-css-nav > nav ul li a			{font-size:1rem; /*line-height:50px;*/ padding:8px 5px 8px 0px;}
...
<div class="cardx card-blogx">
  <div class="card-bodyx pure-css-navx nav-verticalx">
    <h5 class="card-titlex "><?php  echo $settings['title']; ?></h5>
