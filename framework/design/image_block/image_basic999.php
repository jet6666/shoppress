...
add_filter( 'ppt_blocks_args',  	array('block_image_basic999',  'data') );
add_action( 'image_basic999',  		array('block_image_basic999', 'output' ) );
add_action( 'image_basic999-css',  	array('block_image_basic999', 'css' ) );

class block_image_basic999 {
	...
	public static function data($a){ 
		...
		return $a;
		 ...
		 $settings = $CORE->LAYOUT("get_block_settings_defaults", array("image_basic999", "image_block", $settings ) );
